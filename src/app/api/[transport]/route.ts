...
import { TOOL_META } from "@/modules/mcp/catalog";
...
const mcpHandler = createMcpHandler(
  (server) => {
    ...
    server.registerTool(
      ...
      {
        ...TOOL_META.get_activity_timeline,
        inputSchema: {
    ...
    server.registerTool(
      ...
      {
        ...TOOL_META.get_script_stats_block,
        inputSchema: {
          query: z
            .string()
            .min(1)
